...
if __name__ == "__main__":
    ...
    # file = h5py.File('./drive/MyDrive/FYP/FashionGenAttnGAN/data/fashiongen/train/Fashiongen_256_256.h5', 'r')
    # a = file['input_image'][:2000]
    # b = file['input_category'][:2000]
    # dataset = [(a[i], b[i]) for i in range(len(a))]
